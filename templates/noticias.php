    ...
    <div class="container mt-3 mb-5">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <!-- Preview Image -->
          <img class="img-fluid rounded" src="../img/new_44586.jpg" alt="">
        ...
        <hr>
          ...
          <div class="media mb-4">
            <img class="d-flex mr-3 rounded-circle" src="../img/u_1188512dd.png" alt="" style="width: 50px">
          ...
          <div class="media mb-4">
            <img class="d-flex mr-3 rounded-circle" src="../img/u_283988327.jpg" alt="" style="width: 50px">
            <div class="media-body">
              <h5 class="mt-0">Lorena Cruz</h5>
              Gracias a ustedes me entero de las últimas noticias.

              <div class="media mt-4">
                <img class="d-flex mr-3 rounded-circle" src="../img/u_12168484d.jpg" alt="" style="width: 50px">
                <div class="media-body">
