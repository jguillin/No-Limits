...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/cssenciclopedia.css">
    <!-- Bootstrap core CSS -->
    ...
    <header class="container-fluid" id="encabezado">
				...
				<nav class="navbar navbar-expand-md navbar-light bg-light fixed-top justify-content-between">
                    ...
                    <li class="nav-item active">
										...
										<li class="nav-item">
												<a class="nav-link" href="users/login.html">Ingresar</a>
										</li>
								</ul>
						</div>
      ...
      <ul class="navbar-nav d-flex flex-row text-center">
        ...
        <li class="col nav-item">
          <a class="nav-link" href="#">
            <i class="fa fa-book fa-2x m-auto text-primary" aria-hidden="true"></i>
          </a>
        </li>
        <li class="col nav-item">
