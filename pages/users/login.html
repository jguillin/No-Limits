...
<html lang="es">
	...
	<body>
		...
		<section class="text-center mt-5 mb-5 pt-4 pb-5">
			...
			<div class="container">
				<div class="row ">
					<form class="formulario col-10 col-md-6 mx-auto" action="validate.php" method="post">
						...
						<small id="emailHelp" class="form-text text-muted">¿No tienes cuenta?,
							<a href="signup.html">Regístrate</a>.</small>
					</form>
				</div>
			</div>
		</section>
				...
				<ul class="navbar-nav d-flex flex-row text-center">
					...
					<li class="col nav-item">
						<a class="nav-link" href="#">
							<i class="fa fa-user-circle-o fa-2x m-auto text-primary" aria-hidden="true"></i>
						</a>
					</li>
				</ul>
			</nav>
